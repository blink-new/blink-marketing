...
//  2. VideoDemoCard            901      901      15.0 s  (exact — no clipping)
...
const DUR_INTRO       = 90;
const DUR_DEMO_CARD   = DEMO_CARD_FRAMES;
...
export const FULL_VIDEO_FRAMES =
...
// MUSIC_START_S: seconds into the track to start playback.
// Default 4.66 s = 8 beats in — typically where the first main beat drops.
// Adjust to taste after previewing in Remotion Studio.
    ...
    <AbsoluteFill style={{ background: "#ffffff" }}>
      ...
      <Audio
        ...
        volume={(f) =>
          interpolate(
            f,
            [FULL_VIDEO_FRAMES - 60, FULL_VIDEO_FRAMES],
            [0.9, 0],
